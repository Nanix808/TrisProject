...
Revision ID: 131de72e5010
Revises: 
Create Date: 2024-04-14 18:45:42.254574
...
def upgrade() -> None:
    ...
    sa.Enum('LOAD_UNLOAD', 'PICKUP', 'SIGN', name='status').create(op.get_bind())
...
def downgrade() -> None:
    ...
    op.drop_table('role')
    sa.Enum('LOAD_UNLOAD', 'PICKUP', 'SIGN', name='status').drop(op.get_bind())
    # ### end Alembic commands ###
